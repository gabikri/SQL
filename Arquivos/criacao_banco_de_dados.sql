...
#caso eu queira colocar o id, é possível. Mas no values eu devo colocar o default 
#Se a ordem for examente a ordem dos campos não é necessário informar ele no ínicio  
#Existe uma forma de inserir vários dados ao mesmo tempo 


#Comando insert into é da DML - data manipulation language
